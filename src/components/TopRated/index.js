...
class TopRated extends Component {
  ...
  successView = () => {
    const {topRatedMoviesList, searchedResults} = this.state

    const a =
      searchedResults.length === 0 ? topRatedMoviesList : searchedResults
  ...
  failureView = () => <h1>Failed to load TopRated Page</h1>
