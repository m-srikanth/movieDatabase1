...
class UpComing extends Component {
  ...
  successView = () => {
    const {upComingMoviesList, searchedResults} = this.state

    const a =
      searchedResults.length === 0 ? upComingMoviesList : searchedResults
  ...
  failureView = () => <h1>Failed to load UpComing Page</h1>
